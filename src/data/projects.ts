...
export const projects: Project[] = [
  ...
  },
  {
    ...
    images: [
      { src: p4_page2Full,   conceptWidth: true, caption: "Site Plan" },
      { src: p4_page3Full,   conceptWidth: true, caption: "Courtyard Performance Space Render" },
      { src: p4_page4Wall,   conceptWidth: true, caption: "Wall Enlarged Section + Wall Enlarged Plan" },
      { src: p4_page4Render, conceptWidth: true, caption: "Wall Render" },
      { src: p4_page1R,      conceptWidth: true, caption: "Renovation Plan" },
    ],
    referenceImageSrc: p1_2L,
  },
  {
